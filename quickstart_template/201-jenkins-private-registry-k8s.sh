...
#defaults
artifacts_location="https://raw.githubusercontent.com/Vincentliu028/azure-devops-utils/mooncake_sampleapp/"
jenkins_version_location="https://raw.githubusercontent.com/Vincentliu028/azure-devops-utils/mooncake_sampleapp/jenkins/jenkins-verified-ver"
while [[ $# > 0 ]]
do
  key="$1"
  shift
